...
var emailWorker = new bullmq_1.Worker("emailQueue", function (job) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, to, subject, text, html;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = job.data, to = _a.to, subject = _a.subject, text = _a.text, html = _a.html;
                console.log("Processing email job for ".concat(to));
                return [4 /*yield*/, (0, email_1.sendEmail)({ to: to, subject: subject, text: text, html: html })];
            case 1:
                _b.sent();
...
emailWorker.on("failed", function (job, err) {
    console.error("Job ".concat(job === null || job === void 0 ? void 0 : job.id, " failed:"), err.message || err);
