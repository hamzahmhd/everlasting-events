...
exports.insertConsultationEvent = insertConsultationEvent;
var googleapis_1 = require("googleapis");
if (!process.env.GOOGLE_CREDENTIALS) {
    throw new Error("GOOGLE_CREDENTIALS environment variable is not set.");
}
// Load Google API credentials from environment variable
var credentials = JSON.parse(Buffer.from(process.env.GOOGLE_CREDENTIALS, "base64").toString("utf-8"));
var auth = new googleapis_1.google.auth.JWT(credentials.client_email, undefined, credentials.private_key.replace(/\\n/g, "\n"), // Fixes newline formatting issue
["https://www.googleapis.com/auth/calendar"]);
var calendar = googleapis_1.google.calendar({ version: "v3", auth: auth });
function insertConsultationEvent(calendarId, eventDetails) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error("Error inserting event into Google Calendar:", error_1);
